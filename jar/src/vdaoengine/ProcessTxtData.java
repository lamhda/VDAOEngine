	...
	public static void main(String[] args) {
		try{
			...
			if(args.length>0){
				...
				System.out.println("Options: [-center] [-doublecenter] [-selectrowsvar n] [-selectrowsfromfile filename] [-selectuniquebyvar] [-mergefile filename] [-prepare4ICA] [-ordercolumnspc1] [-savetxt] [-transpose] [-logx1] [-decompose sampleFileName#fieldName] [-collapsevar sampleFileName#fieldName#type]");
